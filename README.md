...
Для вывода желаемого пункта меню на произвольной странице, необходимо в контексте передать переменную "menu", содержащую уникальную ссылку желаемого пункта. Без этой ссылки будут выведены пункты меню первого уровня.
